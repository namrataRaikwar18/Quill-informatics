    ...
    <>
      <section id="grid">
        ...
        <p className="paragraph">
          The simple grid below is based on 5 columns. You can add "no-gutter"
          as a class to remove spacing between columns.
        </p>
        ...
        <div className="code-markup">
          ...
          <code className="code-snippet">
            &lt;div className="row"&gt;
            <br />
            &nbsp;&nbsp;&lt;div className="col-two-thirds"&gt;&lt;/div&gt;
            <br />
            &nbsp;&nbsp;&lt;div className="col-one-third"&gt;&lt;/div&gt;
            <br />
            &lt;/div&gt;
        ...
        <p className="paragraph">
          Add class .reverse-order to reverse the order of columns on tablets
          and mobiles.
        </p>
        <div className="code-markup">
          <span className="code-header">Example:</span>
          <code className="code-snippet">
            &lt;div className="row"&gt;
            <br />
            &nbsp;&nbsp;&lt;div className="col-one-half"&gt;&lt;/div&gt;
            <br />
            &nbsp;&nbsp;&lt;div className="col-one-half"&gt;&lt;/div&gt;
            <br />
            &lt;/div&gt;
        ...
        <img
          className="center space-bottom"
          src={reverseOrderImg}
          srcSet={`${reverseOrderImg} ,  ${reverseOrderImg2}`}
          alt="Reverse Order"
        />
        <p className="paragraph">
          Add class .min-two-columns for a minimum of two columns on mobile.
        </p>
        <div className="code-markup">
          <span className="code-header">Example:</span>
          <code className="code-snippet">
            ...
            <br />
            &nbsp;&nbsp;&lt;div className="col-one-fourth"&gt;&lt;/div&gt;
            <br />
            &nbsp;&nbsp;&lt;div className="col-one-fourth"&gt;&lt;/div&gt;
            <br />
            &nbsp;&nbsp;&lt;div className="col-one-fourth"&gt;&lt;/div&gt;
